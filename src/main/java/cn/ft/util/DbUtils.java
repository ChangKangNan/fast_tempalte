...
public class  DbUtils {
     ...
     */
    public List<TableInfo> getAllTables(FileConfig conf, DatabaseMetaData metaData, Set<String> tableNames)
            throws SQLException {
     ...
     * @param tableInfo 表信息
     */
    public void setPrefix(FileConfig conf, TableInfo tableInfo) {
        String prefixName = "";
     ...
     */
    public Connection getConnection(FileConfig conf) throws ClassNotFoundException {
